			...
			<div class="swiper-slide swiper-no-swiping addAddressSlider">
				...
				<form>
					...
					<table class="formTable">
						<tr>
							<td>联系人</td>
							<td><input id="contactName" name="receivePerson" type="text" value=""/></td>
						</tr>
						<tr>
							<td>联系电话</td>
						...
						<tr>
							<td>选择省份</td>
							<td>
								<select name="provinceId" onchange="queryCity(this.value)">
									<option>--请选择省份--</option>
						...
						<tr>
							<td>选择市区</td>
							<td>
								<select name="cityId" onchange="queryArea(this.value)">
									<option>--请选择市区--</option>
								</select>
							</td>
						</tr>
						...
						<tr>
							<td>详细地址</td>
							<td><input type="text" name="addressDetail" value=""/></td>
						</tr>
					</table>
...
<script>
	...
	function querySuccess(data){
		...
		for(var i=0;i<addressList.length;i++){
			...
			html+='<span class="check"><i class="iconfont">&#xe611;</i>设为默认地址</span>';
