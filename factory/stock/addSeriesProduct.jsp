...
<body>
    ...
    <div class="area productDetail">
        <form action="<%=request.getContextPath()%>/stock/addSeriesProduct" method="post" class="form-horizontal" onsubmit="return submitForm();">
            
            <input type="hidden" class="form-control" name="purchaseQuantity" value="1"/>
            <input type="hidden" class="form-control" name="lightType" id="lighttype" value="${product.lightType }"/>
           ...
           <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sx-12 col-lg-9 imgArea" id="pngPicture">
                    ...
                    <div class="col-xs-6 col-sm-2 col-lg-2">
                        <div class="img-content add-content">
                            <input type="file" class="fileInp" accept="image/png"/>
                            <span class="add">&#43;</span>
                            <img src="" alt="" class="img-responsive" />
                            <input type="hidden"  value=""/>
                              <span class="cancel">&#88;</span>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-lg-4 input-group">
                	...
                	<span id="moneyNullInfo" style="color:red;display:none;">价格不能为空</span><br>
                </div>
            </div>
            <div class="form-group">
