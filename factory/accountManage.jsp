...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath() %>/resources/factory/assets/css/personCenter.css?11"/>
</head>
<body class="personCenter">
    <div class="title">账号管理</div>
<form action="<%=request.getContextPath() %>/factory/updateAccountInfo">
<!--[[个人中心--会员-->
<div class="person-member">
    ...
    <!-- <div class="clearfix">
        <a href="#">
            <div class="pull-left"><i class="icon iconfont purple">&#xe61b; </i>推荐人</div>
            <div class="pull-right">热热的心</div>
        </a>
    </div> -->
   <!--  <div class="clearfix">
        <a href="#">
            <div class="pull-left"><i class="icon iconfont blue">&#xe616; </i>性别</div>
            <div class="pull-right">保密</div>
        </a>
    </div> -->
  <!--   <div class="clearfix">
        <a href="#">
            <div class="pull-left"><i class="icon iconfont green">&#xe61c; </i>出生日期</div>
            <div class="pull-right">2000-01-01</div>
        </a>
    </div> -->
    <!-- <div class="clearfix">
        <a href="#">
            <div class="pull-left"><i class="icon iconfont yellow">&#xe614; </i>绑定手机号</div>
            <div class="pull-right">13535252359</div>
        </a>
    </div> -->
    <div class="clearfix">
        <a href="#">
...
<input type="submit" class="btn submit_btn" value="保　存"/>
</form>
<!--个人中心--会员]]-->
...
<script>
	...
	$(function(){
		queryCity(${user.provinceId});
		$("#province").val(${user.provinceId});
