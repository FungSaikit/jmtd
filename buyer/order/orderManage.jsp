...
<div class="selectOrder">
    <ul>
    	...
    	<li class="select_li"><a class="select_a" get="7" href="<%=request.getContextPath()%>/buyer/returnOrderManage?#selected_a" onclick="selectFunction(this)">退款/退货</a></li>
    </ul>
</div>
...
<script type="text/javascript">
    ...
    function loadOrder(){
		var url="<%=request.getContextPath()%>/buyer/orderListAjax";
    ...
    function getServiceBtn(orderForm,orderItem){
    	...
    	if(orderItem.penddingAfterSale>0)
 	   	...
 	   	return '<a href="javascript:toAfterSale('+orderItem.orderItemId+','+orderForm.orderNumber+')" class="roundbutton servicebutton"> 申请售后</a>';
    }
