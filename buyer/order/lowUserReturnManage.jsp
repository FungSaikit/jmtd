...
<div class="selectOrder">
    <ul>
        ...
        <li class="select_li"><a class="select_a" get="7" href="<%=request.getContextPath()%>/buyer/lowUserReturnOrderList?#selected_a" id="selected_a" onclick="selectFunction(this)">退款/退货</a></li>
    </ul>
</div>
...
<script type="text/javascript">
    ...
    function loadOrder(){
		var url="<%=request.getContextPath()%>/buyer/lowUserReturnListAjax";
			            ...
			            complete: function (res) {
			               ...
			               /*  if(res.errMsg=="chooseWXPay:cancel")
			                ...
			                if(res.errMsg=="chooseWXPay:ok"){
			                	window.location.href="<%=request.getContextPath()%>/buyer/lowUserOrderList?orderStatus=<%=OrderStatus.TO_BE_SHIPPED%>";
			                } 
			            }
			        }); 
			    });
