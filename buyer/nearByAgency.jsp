	...
	<body>
		...
		<script>
			...
			function getAgencyList(){
				...
				var params={lng:longitude,lat:latitude,keyword:$("#keyword").val()};
			...
			$(document).on("tap",".navigationDiv span",function(){
				wx.openLocation({
				    latitude: parseFloat($(this).attr("data-lat")), // 纬度，浮点数，范围为90 ~ -90
				    longitude: parseFloat($(this).attr("data-lng")), // 经度，浮点数，范围为180 ~ -180。
			...
			$("#submit").tap(function(){
				window.location.href="<%=request.getContextPath()%>/buyer/nearByAgency?keyword="+$("#keyword").val();
			});
		</script>
	</body>
