...
<script>
	...
	var offset=0;
	function loadOrder(){
		var url="<%=request.getContextPath()%>/buyer/prepareReceiveUserAjax";
	...
	$(document).on("tap",".orderStock",function(){
		window.location.href="<%=request.getContextPath()%>/buyer/prepareReceiveUserDetail?userIdenticalCode="
				+$(this).attr("data-code")+"&buyerId="+$(this).attr("data-id")+"&sellerId=${sellerId}"
	});
