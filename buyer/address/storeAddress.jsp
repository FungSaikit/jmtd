	...
	<div class="swiper-container payContainer">
        <div class="swiper-wrapper">
           <div class="swiper-slide swiper-no-swiping addressSlider">
				<div class="title"><i class="iconfont prevPage normalPrev">&#xe624;</i>管理店铺地址</div>
...
<script>
	...
	function queryReceiveAddress(){
		var url="<%=request.getContextPath()%>/address/queryStoreAddress";
		var params={};
	...
	function querySuccess(data){
		...
		for(var i=0;i<addressList.length;i++){
			...
			html+='<span class="check'+(addressList[i].receiveAddress.defaultFlag==1?' active':'')+'"></span>';
	...
	function getReceiveAddress(receiveAddressId){
		var url="<%=request.getContextPath()%>/address/toUpdateStoreAddress";
	...
	function getSuccess(data){
		...
		$("input[name='receiveAddressId']").val(address.storeAddressId);
	...
	function updateAddress(){
		...
		var url="<%=request.getContextPath()%>/address/updateStoreAddress";
	...
	function addAddress(){
		...
		var url="<%=request.getContextPath()%>/address/addStoreAddress";
		var params=$("form").serialize();
	...
	function deleteAddress(){
		var url="<%=request.getContextPath()%>/address/deleteStoreAddress";
