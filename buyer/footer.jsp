...
<footer class="clearfix text-center footer">
  <a href="<%=request.getContextPath()%>/buyer/index" data-href="<%=request.getContextPath()%>/buyer/index" class="fa footerA width-2 <c:if test='${fActive==0 }'>active</c:if>">
  ...
  <c:choose>
    <c:when test="${sessionScope.openId!='notFollow' }">
    	<a href="<%=request.getContextPath()%>/shopcart/myShopcart" data-href="<%=request.getContextPath()%>/shopcart/myShopcart" class="fa footerA width-2 <c:if test='${fActive==3 }'>active</c:if>">
  ...
  <c:choose>
	    <c:when test="${sessionScope.openId!='notFollow' }">
	    	<a href="<%=request.getContextPath()%>/buyer/personCenter" data-href="<%=request.getContextPath()%>/buyer/personCenter" class="fa footerA width-2 <c:if test='${fActive==4 }'>active</c:if>">
