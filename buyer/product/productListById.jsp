...
<div class="productList">
    <div class="title">${productColumnName}</div>
    <!--[[商品-->
    <div class="page">
...
<input type="hidden" value="0" id="downPageNo"/>
 <form action="<%=request.getContextPath() %>/product/productListById" id="shopProductForm">
 		<input type="hidden" name="productIdList" value="${productIdList }"/>
 		<input type="hidden" name="productColumnName" value="${productColumnName }"/>
...
$(function(){
	...
	function loadProductUp(me){
		...
		$.ajax({
            type: 'GET',
            url: '<%=request.getContextPath()%>/product/productListByIdAjax',
            dataType: 'json',
