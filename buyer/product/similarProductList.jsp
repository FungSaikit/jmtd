      ...
      <div class="product-content">
        ...
        <form class="search" onsubmit="searchByKeyword();return false">
          <div class="formDiv">
              ...
              <a class="searchBtn"  id="photoBtn"><i class="iconfont">&#xe657;</i></a>
              <a class="searchBtn" href="javascript:searchByKeyword()" id="searchBtn" style="display:none;"><i class="iconfont">&#xe610;</i></a>
    ...
    <script>
    	...
    	$(function(){
        	...
        	function similarProduct(){
        		var url="<%=request.getContextPath()%>/product/searchSimilar";
        		var params={file:"${file}"};
        		doAjax("GET",url,params,similarSuccess,fail,true,false);
        	}
