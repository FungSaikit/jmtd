...
<head>
    ...
    <link href="<%=request.getContextPath() %>/resources/customer/assets/css/product.css?bass" rel="stylesheet">
...
<input type="hidden" value="0" id="downPageNo"/>
 <form action="<%=request.getContextPath() %>/product/shopProductList" id="shopProductForm">
