...
<div class="distributor">
    ...
    <form class="form" action="<%=request.getContextPath()%>/buyer/setAfterSaleRepair" onsubmit="return checkForm();">
    	<input type="hidden" name="afterSaleId" value="${afterSaleId }"/>
        <div class="form-group">
            <label>配件</label>
            <input type="text" id="organization" name="afterSaleRepairName" class="form-control"/>
        </div>
        <div class="form-group">
            <label>数量</label>
            <input type="text" id="organization" name="afterSaleNumber" class="form-control"/>	
        </div>
        <!-- <div class="form-group">
            <label>建议打木架</label>
