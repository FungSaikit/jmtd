...
<div class="distributor">
    ...
    <form class="form" <c:choose><c:when test="${application.checkStatus==AUTHENTICATION_SUCCESS||application.isUpdate==1 }">action="<%=request.getContextPath()%>/user/updateFactoryAuthentication"</c:when><c:otherwise>action="<%=request.getContextPath()%>/user/authenticationFactory"</c:otherwise></c:choose> onsubmit="return checkForm();">
...
</div><jsp:include page="/jsp/buyer/footer.jsp"></jsp:include>
