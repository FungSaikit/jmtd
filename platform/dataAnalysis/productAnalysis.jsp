...
<html lang="en">
	...
	<body>
    	...
    	<table data-toggle="table" id="table" data-search="true" data-search-on-enter-key="true"
		    ...
		    <thead>
		        <tr>
		            <th data-field="productName" data-sortable="true" >产品名</th>
		            <th data-fieLd="productBrand">厂家</th>
    ...
    <script type="text/javascript">
   		...
   		function getData(){
   			var url="<%=request.getContextPath()%>/platform/productAnalysisData";
         ...
         return fmt;
   		...
   		$("#table").bootstrapTable({
   			...
   			url: "<%=request.getContextPath()%>/platform/productAnalysisData",
