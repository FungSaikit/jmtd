...
<body>
        ...
        <form action="<%=request.getContextPath()%>/platform/updateLogisticsMap">
        	<input type="hidden" name="logisticsMapId" value="${lm.logisticsMapId}"/>
        	<input name="logisticsCompany" placeHolder="填写物流公司名" value="${lm.logisticsCompany}"/>
        	<input name="logisticsPark" placeHolder="填写所在物流园" value="${lm.logisticsPark}"/>
        	<button>提交</button>
		</form>
    </div><!-- 页面主体的右边]] -->
