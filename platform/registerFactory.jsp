...
<div class="distributor">
    ...
    <form class="form-horizontal form" action="<%=request.getContextPath()%>/platform/registerFactory">
        ...
        <div class="imgDiv">
             <div class="imgContent notEmpty">
                 ...
                 <img src="<c:if test='${!empty application }'>${application.logoPic}</c:if>" alt="" <c:if test='${empty application }'>style="display: none;"</c:if>/>
                 <span class="add" <c:if test='${!empty application }'>style="display: none;"</c:if>><i class="iconfont">&#xe628;</i></span>
                 <input type="file" class="fileInp"/>
             </div>
