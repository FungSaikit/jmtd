...
<body>
	...
	<c:set var="WITHDRAW_PLATFORM" value="<%=CapitalFlowType.WITHDRAW_PLATFORM%>" />
                    	...
                    	<tr>
                        	...
                        	<td>
                        		<c:choose>
		                    		...
		                    		<c:when test="${cf.capitalFlowType==WITHDRAW_PLATFORM}">平台提成</c:when>	
		                    	</c:choose>
                        	</td>
                        	<td>
	                           	<c:choose>
                           ...
                           <td class="textRight moneyText" <c:choose><c:when test="${cf.capitalFlowType==WITHDRAW_TO_WECHAT}">style="color:green"</c:when></c:choose>><c:choose>
		                    		<c:when test="${cf.capitalFlowType==WITHDRAW_PLATFORM||cf.capitalFlowType==COMMISION}">+</c:when>
