...
<body>
    ...
    <div class="area productDetail">
        <form action="<%=request.getContextPath()%>/platform/addProduct" method="post" class="form-horizontal" onsubmit="return submitForm();">
            <input type="hidden" class="form-control" name="purchaseQuantity" value="1"/>
            <input type="hidden" class="form-control" value="12" name="rentTerm" />
           ...
           <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-lg-4 input-group">
                    <input type="text" class="form-control" name="unitPrice" value="${product.unitPrice}" onChange="changePlatformPercent(this.value);halfPrice(this.value);"/>
                </div>
            </div> --%>
            <div class="form-group">
           ...
           <%--  <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="radio-inline">
                    <label>
                        <input type="radio" name="productKind" value="1"> 现货
                    </label>
                </div>
                <div class="radio-inline">
                    <label>
             ...
             <div class="form-group">
                ...
                <div class="col-xs-12 col-lg-4 input-group" id="materialDiv">
                    ...
                    <c:forEach items="${materilList}" var="propertyValue">
                  		...
                  		<c:if test="${propertyValue.propertyValue=='其他' }"><input type="text" name="productOtherMaterial"/></c:if>
                  	</c:forEach>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-xs-12 col-lg-4 input-group" id="spaceDiv">
                	<input type="hidden" name="productSpace"/>
                     <c:forEach items="${spaceList}" var="propertyValue">
                     	...
                     	<c:if test="${propertyValue.propertyValue=='其他'}"><input type="text" name="productOtherSpace"/></c:if>
                   	</c:forEach>
                </div>
            </div>
             <div class="form-group">
                ...
                <div class="col-xs-12 col-lg-4 input-group">
                    <input type="text" class="form-control"  name="productBrand" value="佐为照明"/>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-lg-4 input-group">
                    <input type="date" value="<%=new SimpleDateFormat("yyyy-MM-dd").format(new Date()) %>" class="form-control" name="productOnlineTime" />
                </div>
            </div>
