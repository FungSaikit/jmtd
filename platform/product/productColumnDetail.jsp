...
<body>
    ...
    <div class="area productDetail">
        <form action="<%=request.getContextPath()%>/platform/updateProductColumn" method="post" class="form-horizontal" onsubmit="return submitForm();">
			<input type="hidden" name="productColumnDeleteFlag" value="${productColumn.productColumnDeleteFlag }"/>
			<input type="hidden" name="productColumnId" value="${productColumn.productColumnId }"/>
			<input type="hidden" name="productColumnIndex" value="${productColumn.productColumnIndex }"/>
			<input type="hidden" name="productColumnPropertyValue" value="${productColumn.productColumnPropertyValue }"/>
			<div class="form-group">
                ...
                <div class="col-xs-12 col-lg-4 input-group">
                    <select class="form-control" name="productStyleType" id="productStyleType" >
                    	<option value="0" <c:if test="${productColumn.productStyleType==0 }">selected</c:if>>新中式</option>
                    	<option value="1" <c:if test="${productColumn.productStyleType==1 }">selected</c:if>>非新中式</option>
                    </select>
                </div>
            </div>
			<div class="form-group">
                ...
                <div class="col-xs-12 col-lg-4 input-group">
                    <select class="form-control" name="productColumnType" id="productColumnType" onchange="changeProductColumnType(this.value)">
                    	<option value="0" <c:if test="${productColumn.productColumnType==0 }">selected</c:if>>用已有属性</option>
                    	<option value="1" <c:if test="${productColumn.productColumnType==1 }">selected</c:if>>新栏目</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-xs-12 col-lg-4 input-group">
                    <input class="form-control" name="productColumnName"  id="productColumnName" value="${productColumn.productColumnName }"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-lg-4 input-group">
                    <input class="form-control" name="productColumnUrl"  id="productColumnUrl" value="${productColumn.productColumnUrl }"/>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label  col-xs-12 col-lg-2">*栏目标题</label>
                <div class="col-xs-12 col-lg-4 input-group">
                    <input class="form-control" name="productColumnTitle" value="${productColumn.productColumnTitle }" id="productColumnTitle"/>
                </div>
            </div>
      		<div id="hideDiv" <c:if test="${productColumn.productColumnType==1 }">style="display:none;"</c:if>>
				<div class="form-group">
	                ...
	                <div class="col-xs-12 col-lg-4 input-group">
	                    ...
	                    <c:forEach items="${typeList}" var="propertyValue">
	                    	<option value="${propertyValue.propertyValueId}" <c:if test="${productColumn.productColumnType==0&&propertyValue.propertyValueId eq productColumn.productColumnPropertyValue}">selected="selected"</c:if>>${propertyValue.propertyValue}</option>
	                    </c:forEach>
	                    </select>
	                </div>
	            </div>
	                ...
	                <div class="col-xs-12 col-lg-9 imgArea" id="carouselImg">
	                    ...
	                    <div class="col-xs-6 col-sm-2 col-lg-2">
	                        <div class="img-content add-content">
	                            ...
	                            <img src="${productColumn.productColumnPic }" style="display: block" alt="" class="img-responsive" />
	                            <input type="hidden" name="productColumnPic"  value="${productColumn.productColumnPic }"/>
	                        </div>
	                    </div><!-- 添加图片]] -->
            ...
            <c:if test="${productColumn.productColumnType==1 }">
            <button class="btn btn-primary" type="button" onclick="window.location.href='<%=request.getContextPath()%>/platform/productColumnProductList?productColumnId=${productColumn.productColumnId }'">产品列表</button>
           	</c:if>
        </form>
    </div><!-- 商品详情操作区 -->
